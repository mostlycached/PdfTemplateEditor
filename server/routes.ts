...
const isAuthenticated = (req: Request, res: Response, next: (err?: any) => void) => {
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  async function generateModifiedPdf(originalPdfPath: string, outputPath: string, template: any, customizations: any) {
    try {
      ...
      // Copy all pages except the first from the original PDF
      const pageCount = originalPdfDoc.getPageCount();
      if (pageCount > 1) {
        // Start from index 1 to skip the first page
...
// Function to seed template data
  ...
  try {
    ...
    if (templates.length === 0) {
      ...
      const professionalTemplates = [
        {
          name: 'Corporate Blue',
          imagePath: 'https://images.unsplash.com/photo-1518458028785-8fbcd101ebb9?ixlib=rb-4.0.3&auto=format&fit=crop&w=144&h=108',
          category: 'professional',
        },
        {
          name: 'Minimalist',
          imagePath: 'https://images.unsplash.com/photo-1622737133809-d95047b9e673?ixlib=rb-4.0.3&auto=format&fit=crop&w=144&h=108',
          category: 'professional',
        },
        {
          name: 'Gradient Warmth',
          imagePath: 'https://images.unsplash.com/photo-1557683316-973673baf926?ixlib=rb-4.0.3&auto=format&fit=crop&w=144&h=108',
          category: 'professional',
        },
        {
          name: 'Tech Modern',
          imagePath: 'https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?ixlib=rb-4.0.3&auto=format&fit=crop&w=144&h=108',
          category: 'professional',
        },
        {
          name: 'Abstract Creative',
          imagePath: 'https://images.unsplash.com/photo-1603366445787-09714680cbf1?ixlib=rb-4.0.3&auto=format&fit=crop&w=144&h=108',
          category: 'professional',
        },
        {
          name: 'Business Dark',
          imagePath: 'https://images.unsplash.com/photo-1553095066-5014bc7b7f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=144&h=108',
          category: 'professional',
        },
      ];
      
      // Business document backgrounds
      const businessBackgrounds = [
        {
          name: 'Clean White',
          imagePath: 'https://images.unsplash.com/photo-1586282391129-76a6df230234?ixlib=rb-4.0.3&auto=format&fit=crop&w=144&h=108',
          category: 'business',
        },
        {
          name: 'Geometric Pattern',
          imagePath: 'https://images.unsplash.com/photo-1580554530778-ca36943938b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=144&h=108',
          category: 'business',
        },
        {
          name: 'Abstract Elements',
          imagePath: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?ixlib=rb-4.0.3&auto=format&fit=crop&w=144&h=108',
          category: 'business',
        },
        {
          name: 'Professional Grid',
          imagePath: 'https://images.unsplash.com/photo-1553356084-58ef4a67b2a7?ixlib=rb-4.0.3&auto=format&fit=crop&w=144&h=108',
          category: 'business',
        },
      ];
      
      const allTemplates = [...professionalTemplates, ...businessBackgrounds];
